...
describe('PasswordForget', () => {
    it('Carregar página de esqueci minha senha', () => {
        ...
        expect(text.props.children).toEqual('Enviaremos um link no seu e-mail para que você possa trocar de senha.');
        expect(instance.findByType(<RegularButton/>).props.children).toEqual('Proximo');
    });
});